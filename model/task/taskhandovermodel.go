...
func (m *customTaskHandoverModel) FindByTaskID(ctx context.Context, taskID string) ([]*TaskHandover, error) {
	...
	query := `SELECT * FROM task_handover WHERE task_id = ? AND delete_time IS NULL ORDER BY create_time DESC`
...
func (m *customTaskHandoverModel) FindByTaskNodeID(ctx context.Context, taskNodeID string) ([]*TaskHandover, error) {
	var taskHandovers []*TaskHandover
	query := `SELECT * FROM task_handover WHERE task_node_id = ? AND delete_time IS NULL ORDER BY create_time DESC`
...
func (m *customTaskHandoverModel) FindByFromEmployee(ctx context.Context, fromEmployeeID string, page, pageSize int) ([]*TaskHandover, int64, error) {
	...
	// 查询总数
	countQuery := `SELECT COUNT(*) FROM task_handover WHERE from_employee_id = ? AND delete_time IS NULL`
	...
	query := `SELECT * FROM task_handover WHERE from_employee_id = ? AND delete_time IS NULL ORDER BY create_time DESC LIMIT ? OFFSET ?`
...
func (m *customTaskHandoverModel) FindByToEmployee(ctx context.Context, toEmployeeID string, page, pageSize int) ([]*TaskHandover, int64, error) {
	...
	// 查询总数
	countQuery := `SELECT COUNT(*) FROM task_handover WHERE to_employee_id = ? AND delete_time IS NULL`
	...
	// 分页查询
	offset := (page - 1) * pageSize
	query := `SELECT * FROM task_handover WHERE to_employee_id = ? AND delete_time IS NULL ORDER BY create_time DESC LIMIT ? OFFSET ?`
...
func (m *customTaskHandoverModel) FindByStatus(ctx context.Context, status int) ([]*TaskHandover, error) {
	var taskHandovers []*TaskHandover
	query := `SELECT * FROM task_handover WHERE status = ? AND delete_time IS NULL ORDER BY create_time DESC`
...
func (m *customTaskHandoverModel) FindByPage(ctx context.Context, page, pageSize int) ([]*TaskHandover, int64, error) {
	...
	// 查询总数
	countQuery := `SELECT COUNT(*) FROM task_handover WHERE delete_time IS NULL`
	...
	// 分页查询
	offset := (page - 1) * pageSize
	query := `SELECT * FROM task_handover WHERE delete_time IS NULL ORDER BY create_time DESC LIMIT ? OFFSET ?`
...
func (m *customTaskHandoverModel) SearchTaskHandovers(ctx context.Context, keyword string, page, pageSize int) ([]*TaskHandover, int64, error) {
	...
	// 构建搜索条件
	searchCondition := fmt.Sprintf("(handover_reason LIKE '%%%s%%' OR handover_content LIKE '%%%s%%') AND delete_time IS NULL", keyword, keyword)
...
func (m *customTaskHandoverModel) UpdateStatus(ctx context.Context, id string, status int) error {
	query := `UPDATE task_handover SET status = ?, update_time = NOW() WHERE id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) UpdateApproval(ctx context.Context, id string, approved int, approvalNote string) error {
	query := `UPDATE task_handover SET approved = ?, approval_note = ?, update_time = NOW() WHERE id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) SoftDelete(ctx context.Context, id string) error {
	query := `UPDATE task_handover SET delete_time = NOW() WHERE id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) BatchUpdateStatus(ctx context.Context, ids []string, status int) error {
	...
	query := fmt.Sprintf("UPDATE task_handover SET status = ?, update_time = NOW() WHERE id IN (%s) AND delete_time IS NULL", placeholders)
...
func (m *customTaskHandoverModel) GetTaskHandoverCount(ctx context.Context) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE delete_time IS NULL`
...
func (m *customTaskHandoverModel) GetTaskHandoverCountByStatus(ctx context.Context, status int) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE status = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) GetTaskHandoverCountByTask(ctx context.Context, taskID string) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE task_id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) GetTaskHandoverCountByTaskNode(ctx context.Context, taskNodeID string) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE task_node_id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) GetTaskHandoverCountByFromEmployee(ctx context.Context, fromEmployeeID string) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE from_employee_id = ? AND delete_time IS NULL`
...
func (m *customTaskHandoverModel) GetTaskHandoverCountByToEmployee(ctx context.Context, toEmployeeID string) (int64, error) {
	var count int64
	query := `SELECT COUNT(*) FROM task_handover WHERE to_employee_id = ? AND delete_time IS NULL`
