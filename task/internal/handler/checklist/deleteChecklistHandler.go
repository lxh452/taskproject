...
// 删除任务清单
func DeleteChecklistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteChecklistRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.OkJsonCtx(r.Context(), w, utils.Response.ValidationError(err.Error()))
			return
		}

		l := checklist.NewDeleteChecklistLogic(r.Context(), svcCtx)
		resp, err := l.DeleteChecklist(&req)
		if err != nil {
