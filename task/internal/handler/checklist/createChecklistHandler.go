...
// 创建任务清单
func CreateChecklistHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateChecklistRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.OkJsonCtx(r.Context(), w, utils.Response.ValidationError(err.Error()))
			return
		}

		l := checklist.NewCreateChecklistLogic(r.Context(), svcCtx)
		resp, err := l.CreateChecklist(&req)
		if err != nil {
