...
var BusinessErrorMessages = map[string]string{
	...
	"only_admin_can_revoke":      "只有公司创始人、人事部门或管理人员可以撤销邀请码",
	"only_admin_can_view_invite": "只有公司创始人、人事部门或管理人员可以查看邀请码列表",
	"executor_not_found":         "指定的执行人不存在",
	"task_view_denied":           "无权查看此任务",
	"node_has_dependents":        "有其他任务节点依赖此节点，无法删除",
	"login_too_many_attempts":    "登录失败次数过多，账户已锁定10分钟",
	"admin_not_found":            "用户名或密码错误",
