        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    <!-- 顶部品牌条 -->
                    <tr>
                        <td style="height: 4px; background: linear-gradient(90deg, #1a56db, #3b82f6); border-radius: 12px 12px 0 0;"></td>
                    </tr>
                    <!-- 头部 -->
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            <span style="display: inline-block; padding: 6px 14px; background: #dbeafe; color: #1e40af; font-size: 12px; font-weight: 600; border-radius: 20px; letter-spacing: 0.5px;">新任务</span>
                        </td>
                    </tr>
                    <!-- 主体内容 -->
                    <tr>
                        <td style="padding: 0 40px;">
                            <h1 style="margin: 0 0 8px; font-size: 24px; font-weight: 700; color: #111827;">任务派发通知</h1>
                            <p style="margin: 0 0 24px; font-size: 15px; color: #6b7280;">{{.EmployeeName}}，您有一项新任务需要处理</p>
                        </td>
                    </tr>
                    <!-- 任务信息 -->
                    <tr>
                        <td style="padding: 0 40px 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 10px;">
                                ...
                                <tr>
                                    <td style="padding: 18px 24px; border-bottom: 1px solid #e5e7eb;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">执行节点</p>
                                ...
                                <tr>
                                    <td style="padding: 18px 24px; border-bottom: 1px solid #e5e7eb;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">任务说明</p>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            {{if .BaseURL}}
                            <a href="{{.BaseURL}}/#/tasks/detail/{{.TaskId}}" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #1a56db, #3b82f6); color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(26, 86, 219, 0.3);">查看任务详情</a>
                            {{else}}
                            <a href="/#/tasks/detail/{{.TaskId}}" style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #1a56db, #3b82f6); color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(26, 86, 219, 0.3);">查看任务详情</a>
                            {{end}}
                        </td>
                    </tr>
                    <!-- 页脚 -->
