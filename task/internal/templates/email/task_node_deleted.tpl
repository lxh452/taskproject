        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    <!-- 顶部品牌条 -->
                    <tr>
                        <td style="height: 4px; background: linear-gradient(90deg, #dc2626, #ef4444); border-radius: 12px 12px 0 0;"></td>
                    </tr>
                    <!-- 头部 -->
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            <span style="display: inline-block; padding: 6px 14px; background: #fee2e2; color: #991b1b; font-size: 12px; font-weight: 600; border-radius: 20px; letter-spacing: 0.5px;">节点删除</span>
                        </td>
                    </tr>
                    <!-- 主体内容 -->
                    <tr>
                        <td style="padding: 0 40px;">
                            <h1 style="margin: 0 0 8px; font-size: 24px; font-weight: 700; color: #111827;">任务节点删除通知</h1>
                            <p style="margin: 0 0 24px; font-size: 15px; color: #6b7280;">您负责的任务节点已被删除</p>
                        </td>
                    </tr>
                    <!-- 节点信息 -->
                    <tr>
                        <td style="padding: 0 40px 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 10px;">
                                <tr>
                                    <td style="padding: 18px 24px; border-bottom: 1px solid #fecaca;">
                                ...
                                <tr>
                                    <td style="padding: 18px 24px; border-bottom: 1px solid #fecaca;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">删除时间</p>
                                        <p style="margin: 0; font-size: 15px; color: #374151;">{{.DeleteTime}}</p>
                                    </td>
                                </tr>
                                {{if .OperatorName}}
                                <tr>
                                    <td style="padding: 18px 24px;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">操作人</p>
                                        <p style="margin: 0; font-size: 15px; color: #374151;">{{.OperatorName}}</p>
                                    </td>
                                </tr>
                                {{end}}
                            </table>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            <p style="margin: 0; font-size: 13px; color: #9ca3af;">如有疑问，请联系任务管理员或相关负责人。</p>
                        </td>
                    </tr>
                    <!-- 页脚 -->
                    <tr>
