                    ...
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <span style="display: inline-block; padding: 6px 12px; background: #fef3c7; color: #92400e; font-size: 12px; font-weight: 600; border-radius: 4px; letter-spacing: 0.5px;">进度预警</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 6px;">
                                ...
                                <tr>
                                    <td style="padding: 16px 24px; border-bottom: 1px solid #fde68a;">
                                        ...
                                        <p style="margin: 0; font-size: 14px; font-weight: 600; color: #d97706;">{{.Progress}}%</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 16px 24px;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px;">截止日期</p>
                                        <p style="margin: 0; font-size: 14px; color: #374151;">{{.Deadline}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
