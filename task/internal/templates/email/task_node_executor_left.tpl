                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            <span style="display: inline-block; padding: 6px 14px; background: #fee2e2; color: #991b1b; font-size: 12px; font-weight: 600; border-radius: 20px; letter-spacing: 0.5px;">需要处理</span>
                        </td>
                    </tr>
                    <!-- 主体内容 -->
                    <tr>
                        <td style="padding: 0 40px;">
                            <h1 style="margin: 0 0 8px; font-size: 24px; font-weight: 700; color: #111827;">任务执行人离职通知</h1>
                            <p style="margin: 0 0 24px; font-size: 15px; color: #6b7280;">以下任务节点的执行人已离职，请及时安排交接</p>
                        </td>
                    </tr>
                    <!-- 任务信息 -->
                    <tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 10px;">
                                ...
                                <tr>
                                    <td style="padding: 18px 24px;">
                                        <p style="margin: 0 0 4px; font-size: 12px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">原执行人</p>
                                        <p style="margin: 0; font-size: 15px; color: #374151;">{{.LeftEmployeeName}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            <p style="margin: 0; font-size: 13px; color: #9ca3af;">请登录系统安排新的执行人接手此任务节点。</p>
                        </td>
                    </tr>
                    <!-- 页脚 -->
                    <tr>
