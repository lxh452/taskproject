        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                    <!-- 顶部品牌条 -->
                    <tr>
                        <td style="height: 4px; background: linear-gradient(90deg, #ea580c, #f97316); border-radius: 12px 12px 0 0;"></td>
                    </tr>
                    <!-- 头部 -->
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            <span style="display: inline-block; padding: 6px 14px; background: #ffedd5; color: #9a3412; font-size: 12px; font-weight: 600; border-radius: 20px; letter-spacing: 0.5px;">截止提醒</span>
                        </td>
                    </tr>
                    <!-- 主体内容 -->
                    <tr>
                        <td style="padding: 0 40px;">
                            <h1 style="margin: 0 0 8px; font-size: 24px; font-weight: 700; color: #111827;">任务即将到期</h1>
                            <p style="margin: 0 0 24px; font-size: 15px; color: #6b7280;">您有任务节点即将到期，请及时处理</p>
                        </td>
                    </tr>
                    <!-- 任务信息 -->
                    <tr>
                        <td style="padding: 0 40px 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #fff7ed; border: 1px solid #fed7aa; border-radius: 10px;">
                                <tr>
                                    <td style="padding: 18px 24px; border-bottom: 1px solid #fed7aa;">
                                ...
                                <tr>
                                    <td style="padding: 18px 24px;">
                                        ...
                                        <p style="margin: 0; font-size: 15px; font-weight: 600; color: #ea580c;">{{.Progress}}%</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            <p style="margin: 0; font-size: 13px; color: #9ca3af;">请登录系统查看任务详情并及时完成。</p>
                        </td>
                    </tr>
                    <!-- 页脚 -->
                    <tr>
